...
import { PreparadosService } from '../servicios/preparados.service';
...
export class PreparadosComponent implements OnInit, AfterViewInit{
  ...
  constructor(private cartService:CartService, private preparados:PreparadosService){}
  ...
  ngOnInit(): void {
      ...
      this.preparados.getData().subscribe((data: any[])=>{//solicita la data
